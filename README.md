...
La carica sembra molto alta rispetto a quella fornita dai file originali ma soprattutto presenta una lunghissima coda. Ovviamente il rate dei muoni risulta più bassa in quanto (per forza di cose) ho tolto tutti gli eventi bundle. Quindi è come se analizzassi tutti gli eventi come eventi singoli. La frequenza risulta comunque troppo alta.
